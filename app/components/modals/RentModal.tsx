...
const RentModal = () => {
        ...
        bodyContent = (
            <div className="flex flex-col gap-8">
                <Heading 
                    ...
                    subtitle="Input Amenities of your Place"
                />
                <Counter 
                  title="Guests"
                  subtitle="Number of Guest Allowed"
                  value={guestCount}
    ...
    if (step == STEPS.DESCRIPTION) {
        bodyContent =(
            <div className="flex flex-col gap-8">
                <Heading 
                    title="A Short Info about your Place"
                    subtitle="Make it short and simple!"
                />
                <Input 
                    id="title"
                    label="Title"
